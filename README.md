...
* La red WiFi que el medidor crea para poder consultar la lectura desde un terminal móvil aparecerá como 'red insegura'. El motivo es que carece de contraseña de acceso, para facilitar el uso. Recuerda desconectarte de la red WiFi creada por el medidor para continuar usando tu terminal móvil con normalidad.
